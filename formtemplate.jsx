                    ...
                    <div className="w-full max-w-sm border border-neutral-800 rounded-2xl p-8">
                        ...
                        <form className="flex flex-col gap-4">
                            <div className="flex flex-col gap-2.5">
                                ...
                                <input type="text" placeholder="Enter your name" className="bg-neutral-950 border border-neutral-800 rounded-lg px-4 py-3 text-sm text-white placeholder-zinc-600 outline-none focus:border-neutral-600 transition-colors" />
                            </div>
                            <div className="flex flex-col gap-2.5">
                            ...
                            <div className="flex flex-col gap-2.5">
                                ...
                                <textarea placeholder="Your message.." rows="4" className="bg-neutral-950 border border-neutral-800 rounded-lg px-4 py-3 text-sm text-white placeholder-zinc-600 outline-none focus:border-neutral-600 transition-colors resize-none"></textarea>
                            </div>
                            <button type="submit" className="bg-green-600 hover:bg-green-700 text-white text-base py-3 rounded-lg transition-colors cursor-pointer mt-1">Send Message</button>
                        </form>
                    </div>
                </div>
            </section>
